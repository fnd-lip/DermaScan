...
export const CabecalhoAutenticacao: React.FC<CabecalhoAutenticacaoProps> = ({
  ...
  if (modoEsqueciSenha) {
    descricao = "Recupere sua senha clínica do DermaScan";
  } else if (tipo === "login") {
    descricao = "Faça login com suas credenciais clínicas autorizadas";
  } else {
    descricao = "Crie sua assinatura para iniciar o diagnóstico assistido";
  }
