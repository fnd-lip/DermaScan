...
} from '../components/auth/AlertaAutenticacao';
...
export const TelaLoginCadastro: React.FC<TelaLoginCadastroProps> = ({
  ...
  return (
    <div className="w-full bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/70 p-8 shadow-2xl shadow-teal-900/10 relative overflow-hidden transition-all duration-300">
      <div className="absolute top-0 inset-x-0 h-1.5 bg-linear-to-r from-teal-500 via-emerald-500 to-indigo-600" />
      ...
      {formulario.modoEsqueciSenha ? (
        ...
        <>
          <FormularioLoginCadastro
            ...
            onAlternarSenha={() =>
              formulario.setMostrarSenha(!formulario.mostrarSenha)
            }
